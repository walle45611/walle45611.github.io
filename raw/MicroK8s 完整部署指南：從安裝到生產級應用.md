...
created: 2026-04-19
description: 在最近專題開發的過程中，我反覆安裝與測試了多次 MicroK8s，期間踩了不少坑，也累積了許多實戰經驗。因此，我決定整理這篇 Blog，讓自己以後部署時可以有一份可直接複製使用的指令手冊，也幫助正在學習 Kubernetes 的朋友少走一些彎路。 本文是基於 MicroK8s 官方文件、Helm、Argo CD Image Updater 等官方說明整合的安裝流程，並修正了常見名詞與設定錯誤，方便
tags:
  - clippings
  - web
---
