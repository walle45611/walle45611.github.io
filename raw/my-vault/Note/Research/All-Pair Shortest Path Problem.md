...
blog_url: https://blog.walle4561.com/articles/posts/all-pairs-shortest-paths/
---
...
- **狀態定義**：令 $A^{k}(i,j)$ 為「從 $i$ 到 $j$ 的最短路成本，且中繼頂點的索引不大於 $k$」。
    ...
    - 遞迴：   
![[Assets/Note/Research/All-Pair Shortest Path Problem/diagram-01.png]]
$$  
...
- **備忘**
    ...
    - 需要實際路徑就維護前驅矩陣（如上）。
## 範例
![[Assets/Note/Research/All-Pair Shortest Path Problem/01-範例.png]]
## 應用
- **目標**
...
![[Assets/Note/Research/All-Pair Shortest Path Problem/02-應用.png]]
...
![[Assets/Note/Research/All-Pair Shortest Path Problem/03-5. 複雜度總結.png]]
...
## 範例
![[Assets/Note/Research/All-Pair Shortest Path Problem/04-範例.png]]
