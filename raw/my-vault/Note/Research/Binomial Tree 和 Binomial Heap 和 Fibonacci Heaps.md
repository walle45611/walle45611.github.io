---
blog: true
blog_title: "二項樹、二項堆與費波那契堆"
blog_date: 2026-09-24
blog_url: https://blog.walle4561.com/articles/posts/binomial-and-fibonacci-heaps/
---
...
- 高度為 k 的 Binomial Tree，記為 **Bₖ**，是由 **兩個 Bₖ₋₁** 的 Binomial Trees 所組成。
	...
	- 另一個作為其子樹。
![[Assets/Note/Research/Binomial Tree 和 Binomial Heap 和 Fibonacci Heaps/01-定義 - 另一個作為其子樹。.png]]
## 定理
...
3. 得到答案
![[Assets/Note/Research/Binomial Tree 和 Binomial Heap 和 Fibonacci Heaps/02-範例 - 得到答案.png|500]]
...
![[Assets/Note/Research/Binomial Tree 和 Binomial Heap 和 Fibonacci Heaps/03-範例.png]]
...
#### 範例
![[Assets/Note/Research/Binomial Tree 和 Binomial Heap 和 Fibonacci Heaps/04-範例.png]]
...
![[Assets/Note/Research/Binomial Tree 和 Binomial Heap 和 Fibonacci Heaps/05-Fibonacci Heap (F-Heap).png]]
## 定義
...
1. **Delete**：刪除任意指定節點，**Delete** 的攤銷時間：$O(1)$，將原圖刪除 12 後。
	![[Assets/Note/Research/Binomial Tree 和 Binomial Heap 和 Fibonacci Heaps/06-定義.png]]
...
將原圖把 15 減掉 4 之後的變化
![[Assets/Note/Research/Binomial Tree 和 Binomial Heap 和 Fibonacci Heaps/07-Decrease-key.png]]
### 重點說明
...
![[Assets/Note/Research/Binomial Tree 和 Binomial Heap 和 Fibonacci Heaps/08-結果狀態 (圖 b).png|600]]
