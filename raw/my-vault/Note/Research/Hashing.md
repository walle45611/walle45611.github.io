...
blog_url: https://blog.walle4561.com/articles/posts/hashing/
---
...
![[Assets/Note/Research/Hashing/01-Proof.png]]
...
* **範例** 設 $B=10$，$H(x)=x\bmod 10$，選 $R=7$，故 $f(x)=7-(x\bmod 7)$。依序插入：$3,14,9,10,23,33,43$。 
	![[Assets/Note/Research/Hashing/02-Double Hashing.png|350]]
