---
blog: true
blog_title: "線性時間排序演算法"
blog_date: 2026-09-24
blog_url: https://blog.walle4561.com/articles/posts/linear-time-sorting/
---

# Counting Sort
![[Assets/Note/Research/Linear-time sorting algo/01-Counting Sort.png]]
![[Assets/Note/Research/Linear-time sorting algo/02-Counting Sort.png]]
...
- **步驟**
	...
	3. ==前綴和：對 $i=1..k$，令 $C[i] \leftarrow C[i]+C[i-1]$==
...
![[Assets/Note/Research/Linear-time sorting algo/03-以基底 r 取第 pos 位(pos=0 為最低位).png]]
...
![[Assets/Note/Research/Linear-time sorting algo/04-Bucket Sort (CLRS) or MSD Radix Sort.png|400]]
