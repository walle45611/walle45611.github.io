...
blog_url: https://blog.walle4561.com/articles/posts/single-source-shortest-paths/
---
...
## 範例
![[Assets/Note/Research/Single-Source Shortest Paths Problem/01-範例.png]]
# Dijkstra Algorithm
...
![[Assets/Note/Research/Single-Source Shortest Paths Problem/02-資料結構版本 adj matrix.png]]
## 演算法版本

![[Assets/Note/Research/Single-Source Shortest Paths Problem/03-演算法版本.png]]
![[Assets/Note/Research/Single-Source Shortest Paths Problem/04-演算法版本.png]]
## 複雜度分析
...
![[Assets/Note/Research/Single-Source Shortest Paths Problem/diagram-01.png]]
...
- 理由：用最多 $k$ 邊到 $i$ 的最短路，只可能是
	...
	![[Assets/Note/Research/Single-Source Shortest Paths Problem/05-定義.png|400]]
- 步驟
...
### CLRS 版本
![[Assets/Note/Research/Single-Source Shortest Paths Problem/06-CLRS 版本.png]]
時間複雜度 $O(VE)$，那麼是因為 base on adj list
## 範例
![[Assets/Note/Research/Single-Source Shortest Paths Problem/07-範例.png]]
![[Assets/Note/Research/Single-Source Shortest Paths Problem/08-範例.png|500]]