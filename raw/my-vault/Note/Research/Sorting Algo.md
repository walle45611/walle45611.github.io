...
blog_url: https://blog.walle4561.com/articles/posts/sorting-algorithms/
---
...
![[Assets/Note/Research/Sorting Algo/01-==Horowitz 分析補充(LOO 概念)==.png]]
...
![[Assets/Note/Research/Sorting Algo/02-Shell's Sort.png|500]]
...
```
![[Assets/Note/Research/Sorting Algo/03-Hoare partition.png|500]]
...
def quicksort(A, p, r):
    if p < r:
        ...
        quicksort(A, q+1, r)
```
![[Assets/Note/Research/Sorting Algo/04-Lomuto partition(Cormen CLRS).png|300]]
## Quick Sort 分析
...
- **Average**：所有切點等機率，期望高度 $\Theta(\log n)$ ⇒ 總成本 $\Theta(n\log n)$，可以想像切分了 $n$ 和 $n-s$。
	![[Assets/Note/Research/Sorting Algo/05-遞迴式推導.png]]
...
## Iterative
![[Assets/Note/Research/Sorting Algo/06-Iterative.png|400]]
- 先把每個元素都變成一個 run
...
## Recursive
![[Assets/Note/Research/Sorting Algo/07-Recursive.png|600]]
...
### Loser tree
![[Assets/Note/Research/Sorting Algo/08-Loser tree.png|400]]
...
### Winner tree
![[Assets/Note/Research/Sorting Algo/09-Winner tree.png|400]]
...
![[Assets/Note/Research/Sorting Algo/10-步驟.png|400]]
...
![[Assets/Note/Research/Sorting Algo/11-Decision tree.png]]
