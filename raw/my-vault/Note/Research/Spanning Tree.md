---
blog: true
blog_title: "Spanning Tree"
blog_date: 2026-09-24
blog_url: https://blog.walle4561.com/articles/posts/spanning-tree/
---
...
![[Assets/Note/Research/Spanning Tree/01-圖形例子.png|600]]
![[Assets/Note/Research/Spanning Tree/02-圖形例子.png|600]]
## DFS 與 BFS 生成樹的差異
...
![[Assets/Note/Research/Spanning Tree/03-Cut Theory.png]]
...
### 手寫範例
> [!note]- 手寫範例
> ![[Assets/Note/Research/Spanning Tree/04-手寫範例.png|500]]
### 實作（Like C）

#### CLRS 版（先整體排序）
![[Assets/Note/Research/Spanning Tree/05-CLRS 版(先整體排序).png]]
...
![[Assets/Note/Research/Spanning Tree/06-DS 版(鄰接矩陣,無堆,$O(V^2)$).png]]
#### CLRS 版（鄰接表 + 最小堆，O($E\log V$)）

適合稀疏圖與實作，也是使用鬆弛這個方式也就是說找到新路近看有沒有連到如果有就更新如果更小的話 (relaxation)。

![[Assets/Note/Research/Spanning Tree/07-CLRS 版(鄰接表 + 最小堆,O($E log V$)).png|500]]
...
![[Assets/Note/Research/Spanning Tree/08-CLRS 版(鄰接表 + 最小堆,O($E log V$)).png]]
### 複雜度對照
...
## Sollin's Algorithm
![[Assets/Note/Research/Spanning Tree/09-Sollin's Algorithm.png]]
