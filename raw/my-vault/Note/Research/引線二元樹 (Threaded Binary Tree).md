---
blog: true
blog_title: "引線二元樹 (Threaded Binary Tree)"
blog_date: 2026-09-24
blog_url: https://blog.walle4561.com/articles/posts/threaded-binary-tree/
---
...
![[Assets/Note/Research/引線二元樹 (Threaded Binary Tree)/Threaded Binary Tree 完整示意圖.png]]
...
### 🧐 圖解說明
![[Assets/Note/Research/引線二元樹 (Threaded Binary Tree)/Threaded Binary Tree 示意圖.png#center]]
...
![[Assets/Note/Research/引線二元樹 (Threaded Binary Tree)/引線二元樹插入 case 1.png#center|500]]

### Case 2：`S` 原本有右子樹（`S.Rthread == false`）

![[Assets/Note/Research/引線二元樹 (Threaded Binary Tree)/引線二元樹插入 case 2.png#center|500]]
