---
blog: true
blog_title: "MicroK8s 完整部署指南：從安裝到生產級應用"
blog_date: 2025-08-08
blog_url: https://blog.walle4561.com/articles/posts/microk8s-完整部署指南-從安裝到生產級應用/
---
...
```bash
kubectl label nodes dev-master1 node-role.kubernetes.io/control-plane=control-plane
kubectl taint nodes dev-master1 node-role.kubernetes.io/control-plane=:NoSchedule
```
